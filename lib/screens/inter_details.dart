...
class InterDetailScreen extends StatefulWidget {
  final String title;
  ...
  @override
  _InterDetailScreenState createState() => _InterDetailScreenState();
}

class _InterDetailScreenState extends State<InterDetailScreen> {
